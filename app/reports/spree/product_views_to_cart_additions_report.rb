...
module Spree
  # Product Views To Cart Additions Report
  class ProductViewsToCartAdditionsReport < Spree::Report
    DEFAULT_SORTABLE_ATTRIBUTE = :product_name
    HEADERS                    = { product_name: :string, views: :integer,
                                   cart_additions: :integer, cart_to_view_ratio: :string }.freeze
    SEARCH_ATTRIBUTES          = { start_date: :product_view_from,
                                   end_date: :product_view_till }.freeze
    SORTABLE_ATTRIBUTES        = [:product_name, :views, :cart_additions].freeze
    ...
    class Result < Spree::Report::Result
      ...
      class Observation < Spree::Report::Observation
        observation_fields [:product_name, :product_slug, :views, :cart_additions,
                            :cart_to_view_ratio]
    ...
    def report_query
      ...
      total_views =
        Spree::Product.by_store(Spree::Store.current)
